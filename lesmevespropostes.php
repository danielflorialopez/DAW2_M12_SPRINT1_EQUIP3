	...
	<body class="home">
		...
		<div class="container info margin-top">  
			...
			<?php
				...
				echo "<tr><td>Soport USB</td><td>Impresora 3D</td><td>Deltebre</td><td>18/03/2021</td><td>Fet</td><td><a href=\"modpropostes.php\"class=\"fa fa-lg fa-edit edit-icon fa2\"></a><a href=\"elimrecursos.php\" class=\"fa fa-lg fa-trash-o fa2\"></a></td><tr>";
				echo "</tbody></table>";
			?>
